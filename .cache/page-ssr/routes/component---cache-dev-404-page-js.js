...
var Dev404Page = /*#__PURE__*/function (_React$Component) {
  function Dev404Page(props) {
    ...
    _this = _callSuper(this, Dev404Page, [props]);
    ...
    var urlState = query_string__WEBPACK_IMPORTED_MODULE_2__.parse(location.search);
    ...
    _this.showCustom404 = _this.showCustom404.bind(_this);
    _this.handlePagePathSearch = _this.handlePagePathSearch.bind(_this);
    _this.handleSearchTermChange = _this.handleSearchTermChange.bind(_this);
    return _this;
  }
  _inherits(Dev404Page, _React$Component);
  return _createClass(Dev404Page, [{
    ...
    key: "handlePagePathSearch",
    value: function handlePagePathSearch(event) {
    ...
    key: "getFilteredPagePaths",
    value: function getFilteredPagePaths(allPagePaths, pagePathSearchTerms) {
      var searchTerm = new RegExp("".concat(pagePathSearchTerms));
    ...
    key: "setSearchUrl",
    value: function setSearchUrl(searchValue) {
      var _this$props$location = this.props.location,
        pathname = _this$props$location.pathname,
        search = _this$props$location.search;
      var searchMap = query_string__WEBPACK_IMPORTED_MODULE_2__.parse(search);
      searchMap.filter = searchValue;
      var newSearch = query_string__WEBPACK_IMPORTED_MODULE_2__.stringify(searchMap);
      if (search !== "?".concat(newSearch)) {
        (0,gatsby__WEBPACK_IMPORTED_MODULE_1__.navigate)("".concat(pathname, "?").concat(newSearch), {
          replace: true
        });
      }
    }
    ...
    value: function render() {
      ...
      if (pathname === "/") {
        ...
        newAPIPath = "src".concat(pathname, ".js");
      } else if (pathname.slice(-1) === "/") {
        newFilePath = "src/pages".concat(pathname.slice(0, -1), ".js");
      } else {
        newFilePath = "src/pages".concat(pathname, ".js");
      }
      return this.state.showCustom404 ? this.props.custom404 : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Gatsby.js development 404 page"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "There's not a page or function yet at", " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("code", null, pathname)), this.props.custom404 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
        ...
        type: "submit",
        value: "Submit"
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, this.state.pagePaths.map(function (pagePath, index) {
        return index < 100 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
          key: pagePath
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
          to: pagePath
        }, pagePath));
      }), this.state.pagePaths.length > 100 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
        style: {
          fontWeight: "bold"
        }
...
_defineProperty(Dev404Page, "propTypes", {
